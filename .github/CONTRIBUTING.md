# Contributing to iiBar

The following is a set of guidelines to contribute to iiBar on GitHub.
...
2. Clone your fork locally
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/iiBar.git
   ```
...
5. When ready, open a pull request against `stonerl/iiBar:development`
...
If the app crashed — attaching a log file will help us significantly, you can find these in iiBar's settings under the General tab.

### Translations

Translations are managed on [Crowdin](https://crowdin.com/project/iibar). If you want to help translate iiBar into your language or improve existing translations, please contribute there directly.
...
1. Open `iiBar.xcodeproj` in Xcode 26 or later
...
iiBar uses [SwiftLint](https://github.com/realm/SwiftLint) and [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) to enforce consistent code style.
...
Open a pull request via the [iiBar pull requests page][pr] and select the [appropriate template][prt] — it will guide you through the required information and checklist.
...
[it]: https://github.com/stonerl/iiBar/issues
[pr]: https://github.com/stonerl/iiBar/pulls
[prt]: https://github.com/stonerl/iiBar/blob/development/.github/pull_request_template.md
