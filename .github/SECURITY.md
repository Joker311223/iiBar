...
Thank you for helping keep iiBar secure. We take the security of our users and their data seriously. 

## Supported Versions

Since iiBar is a macOS menu bar manager, we primarily support security updates for the latest stable release. Please ensure you are running the most recent version of iiBar before submitting a vulnerability report.
...
As a macOS application, iiBar may interact with local system APIs and require certain permissions (like Accessibility or Screen Recording, depending on features). 
...
- Issues related to third-party macOS libraries, unless there is a specific mitigation iiBar needs to implement.

## Reporting a Vulnerability

Please **do not** report security vulnerabilities through public GitHub issues. 

Instead, please report them using [GitHub's Private Vulnerability Reporting](https://github.com/stonerl/iiBar/security/advisories/new) if it is enabled for this repository. 
...
- Your macOS version and the version of iiBar you are testing against.
