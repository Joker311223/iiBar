...
struct ContentView: View {
        ...
        GroupBox("Quick Actions") {
            VStack(spacing: 6) {
                ...
                HStack {
                    ...
                    actionButton("Toggle Bar", action: "toggle-iibarbar")
                }
                HStack {
    ...
    private var setSection: some View {
        GroupBox("Set Setting (iibar://set)") {
            VStack(spacing: 6) {
                HStack {
                    Text("Key:")
    ...
    private var toggleSection: some View {
        GroupBox("Toggle Setting (iibar://toggle)") {
            VStack(spacing: 6) {
    ...
    private var getSection: some View {
        GroupBox("Get Setting (iibar://get → iibarctl://callback)") {
            VStack(spacing: 6) {
        ...
        GroupBox("Authorization") {
            VStack(spacing: 6) {
                Button("Request Authorization") { engine.sendAuthorize() }
                    .buttonStyle(.bordered)
                    .controlSize(.small)
                Text("Triggers whitelist dialog in iiBar")
                    .font(.caption2)
