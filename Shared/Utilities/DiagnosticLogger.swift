...
///
/// Log files are written to `~/Library/Logs/iiBar/`.
final class DiagnosticLogger: @unchecked Sendable {
    ...
    var logDirectory: URL {
        ...
        return home
            ...
            .appendingPathComponent("iiBar", isDirectory: true)
    }
    ...
    private let osLog = Logger(
        subsystem: Bundle.main.bundleIdentifier ?? "com.joker311223.iiBar",
    ...
    private let writeQueue = DispatchQueue(
        label: "com.joker311223.iiBar.DiagnosticLogger.writeQueue",
        qos: .utility
    )
    ...
    private func openLogFile() {
        ...
        let fileName = "iibar_\(fileNameFormatter.string(from: Date())).log"
