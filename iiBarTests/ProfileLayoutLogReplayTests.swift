...
import CoreGraphics
@testable import iiBar
import XCTest

/// Log-replay harness for the profile-layout decision path.
///
/// Parses real iiBar log lines into per-cycle records and drives the actual
...
/// shape iiBar observed on this cycle, did the planner deem the right items
...
final class ProfileLayoutLogReplayTests: XCTestCase {
    ...
    /// recorded. If a control item's namespace or title changes in the iiBar
    ...
    func testLoggedDesiredVisibleIsUsedInsteadOfInference() throws {
        let log = """
        2026-05-30 09:00:00.000 [DEBUG] [MenuBarItemManager] applyProfileLayout: current visible section has 3 items: ["com.joker311223.iiBar:iiBar.ControlItem.Visible", "com.example.extra:Item-0", "com.rogueamoeba.soundsource:SSMainAppMenuIcon"]
        ...
        2026-05-30 09:00:00.004 [DEBUG] [MenuBarItemManager] Profile layout Phase 1: ahCtrlUID=com.joker311223.iiBar:iiBar.ControlItem.AlwaysHidden, crossSectionMoves=0, totalSectionMismatch=0
    ...
    /// Replays a real field cycle (iibar_2026-06-07_09-48-52.log, 11:44:42)
    ...
    func testDisplayReconnectNegativeBudgetYieldsNoOverflow() throws {
        let log = """
        2026-06-07 11:44:42.027 [DEBUG] [MenuBarItemManager] applyProfileLayout: current visible section has 4 items: ["leits.MeetingBar:Item-0", "eu.exelban.Stats:CPU_bar_chart", "com.joker311223.iiBar:iiBar.ControlItem.Visible", "com.apple.TextInputMenuAgent:Item-0"]
    ...
    /// Replays a real field cycle (iibar_2026-06-11_09-11-10.log, 11:31:05) on
    ...
    /// that stale geometry and moved the iiBar visible icon to the far left. The
...
/// Parses iiBar profile-layout log text into replayable cycles and drives the
...
enum ProfileLayoutLogReplay {
    ...
    private static let visibleCtrlUID = "com.joker311223.iiBar:iiBar.ControlItem.Visible"
    private static let hiddenCtrlUID = "com.joker311223.iiBar:iiBar.ControlItem.Hidden"
...
extension ProfileLayoutLogReplay.Cycle {
    ...
    func partitionInputs(unresolvedSourcePIDBaseUIDs: Set<String>) -> ProfileLayoutLogReplay.PartitionInputs {
        ...
        // derived from them through live iiBar code (uniqueIdentifier,
...
/// (e.g. an in-app update) iiBar must arm a settling period so the move pass
