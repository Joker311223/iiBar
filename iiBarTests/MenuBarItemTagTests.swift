...
final class MenuBarItemTagNamespaceTests: XCTestCase {
    ...
    func testiiBarNamespace() {
        let iibar = MenuBarItemTag.Namespace.iibar
        XCTAssertTrue(iibar.isString)
        XCTAssertEqual(iibar.description, Constants.bundleIdentifier)
    }
