...
///
/// Pins down two invariants the field-reported "iiBar icon keeps moving"
/// regression turned out to depend on:
///
/// 1. All three iiBar control items (hidden, alwaysHidden, visible) are
...
final class PartitionUnmanagedUIDsTests: XCTestCase {
    ...
    func testAllThreeControlItemsExcluded() {
        let hidden = "com.joker311223.iiBar:iiBar.ControlItem.Hidden"
        let ah = "com.joker311223.iiBar:iiBar.ControlItem.AlwaysHidden"
        let visible = "com.joker311223.iiBar:iiBar.ControlItem.Visible"
