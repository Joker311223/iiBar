...
final class PlanNotchOverflowTests: XCTestCase {
    ...
    private let chevron = "iibar:VisibleControlItem"
    private let hiddenCtrl = "iibar:HiddenControlItem"
    private let ahCtrl = "iibar:AlwaysHiddenControlItem"
    ...
    /// iiBar icon near the end of the visible section (items after it), not at
