...
final class FlattenCurrentSectionsTests: XCTestCase {
    private let hiddenCtrl = "com.joker311223.iiBar:iiBar.ControlItem.Hidden"
    private let ahCtrl = "com.joker311223.iiBar:iiBar.ControlItem.AlwaysHidden"
    ...
    func testOrderWithAlwaysHiddenPresent() {
        let visibleCtrl = "com.joker311223.iiBar:iiBar.ControlItem.Visible"
