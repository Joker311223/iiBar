...
/// A trimmed, verbatim excerpt from a field-captured iiBar log used as the
/// first fixture for the profile-layout log-replay harness.
///
/// Source: iibar_2026-05-29_17-13-13.log (a ~23k-line capture reported by a
...
///
/// iiBar does not log the desired visible set (only desiredHidden / desiredAH),
...
enum LittleSnitchOrphanLog {
    ...
    2026-05-29 17:13:37.430 [DEBUG] [MenuBarItemManager] applyProfileLayout: current visible section has 3 items: ["com.joker311223.iiBar:iiBar.ControlItem.Visible", "com.apple.controlcenter:Item-0", "com.rogueamoeba.soundsource:SSMainAppMenuIcon"]
    ...
    2026-05-29 17:13:37.436 [DEBUG] [MenuBarItemManager] Profile layout Phase 1: ahCtrlUID=com.joker311223.iiBar:iiBar.ControlItem.AlwaysHidden, crossSectionMoves=0, totalSectionMismatch=0
    2026-05-29 17:13:37.436 [DEBUG] [MenuBarItemManager] Profile layout Phase 1: currentHidden=["app.updatest.Updatest:Item-0", "com.apple.systemuiserver:com.apple.menuextra.TimeMachine", "com.microsoft.OneDrive-mac:Item-0", "com.joker311223.iiBar:iiBar.ControlItem.AlwaysHidden", "com.wireguard.macos:Item-0", "org.eduvpn.app:Item-0"]
    ...
    2026-05-29 18:01:11.245 [DEBUG] [MenuBarItemManager] applyProfileLayout: current visible section has 3 items: ["com.joker311223.iiBar:iiBar.ControlItem.Visible", "com.rogueamoeba.soundsource:SSMainAppMenuIcon", "at.obdev.littlesnitch.agent:Item-0"]
    ...
    2026-05-29 18:01:11.247 [DEBUG] [MenuBarItemManager] Profile layout Phase 1: ahCtrlUID=com.joker311223.iiBar:iiBar.ControlItem.AlwaysHidden, crossSectionMoves=0, totalSectionMismatch=0
