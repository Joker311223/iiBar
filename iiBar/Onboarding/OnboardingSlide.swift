...
enum OnboardingSlide: Int, CaseIterable, Identifiable {
    ...
    var description: LocalizedStringResource {
        switch self {
        case .welcome:
            "iiBar gives you complete control over your menu bar — hide clutter, customize the look, and automate your workflow."
        case .menuBarManagement:
        ...
        case .hotkeysAutomation:
            "Trigger any action with a keystroke. Combine auto-rehide timers and Focus Filter integration so iiBar adapts to whatever you're doing."
        case .profiles:
            "Save your current configuration as a named profile. Switch between layouts instantly, or let iiBar switch automatically when you change your frontmost app."
        case .permissions:
            "iiBar needs a couple of permissions to manage your menu bar. You can grant them now, or skip and grant them later from Settings."
        }
    }
}
