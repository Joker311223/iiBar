...
/// The iiBar control-item divider, styled after the "Dot" IceIcon
...
//
// Zooms into the right side of the menu bar. The iiBar capsule divider is the
...
// mode changes, iiBar auto-activates the linked profile and swaps the entire
...
final class ProfilesMockupModel: ObservableObject {
    ...
    /// same kind of system icons iiBar actually manages — so swapping profiles
