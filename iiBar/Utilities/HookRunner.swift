...
enum HookRunner {
    ...
    static func run(
        ...
        env["IIBAR_HOOK_PHASE"] = context.phase.rawValue.capitalized
        env["IIBAR_HOOK_SCOPE"] = context.scope.rawValue.capitalized
        env["IIBAR_PROFILE_ID"] = context.profileID.uuidString
        env["IIBAR_PROFILE_NAME"] = context.profileName
        env["IIBAR_PREVIOUS_PROFILE_ID"] = context.previousProfileID?.uuidString ?? ""
        env["IIBAR_PREVIOUS_PROFILE_NAME"] = context.previousProfileName ?? ""
