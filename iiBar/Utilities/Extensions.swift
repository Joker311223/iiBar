...
extension Bundle {
    ...
    /// cannot be found for either key, this accessor returns `iiBar`.
...
extension NSScreen {
    ...
    /// The connected screens excluding iiBar's transient resolver virtual
    /// display.
    ///
    ...
    /// instead of screens keeps that phantom out of per-display state (iiBar's
