...
/// App-specific constants for the main iiBar target.
...
enum Constants {
    ...
    static let repositoryURLInfoPlistKey = "iiBarRepositoryURL"

    /// Info.plist key used to configure the donation URL.
    static let donateURLInfoPlistKey = "iiBarDonateURL"

    /// Info.plist key used to configure the executable URI for
    /// `MenuBarItemSpacingManager` shell commands.
    static let menuBarItemSpacingExecutableURIInfoPlistKey = "iiBarMenuBarItemSpacingExecutableURI"
