...
final class GeneralSettings: ObservableObject {
    ...
    /// A Boolean value that indicates whether to use the iiBar Bar
    ...
    /// The location where the iiBar Bar appears.
    @Published var iceBarLocation = Defaults.DefaultValue.iceBarLocation

    /// A Boolean value that indicates whether the iiBar Bar should
